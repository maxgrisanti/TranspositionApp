...
#inputfolder="/Users/harikoornala/Downloads/work"
#outputfolder="/Users/harikoornala/Downloads/work"
...
with open(f"{outputfolder}/Output.txt", "w") as text_file:
    text_file.write("Input Folder: %s" % inputfolder)
    text_file.write("Output Folder: %s" % outputfolder)
...
def main():
    ...
    for _, fn in enumerate(list_of_images):
        ...
        try:
            process_image(inputfolder, fn, f)
        except Exception as e:
            print(e)
            print(f'{inputfolder}-{fn} has been failed !!')
            pass
