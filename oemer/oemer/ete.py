...
def image_to_musicxml(image_path, output_path="./output.musicxml", use_tf=False, save_cache=False, without_deskew=False):
    # Check if the input image file exists
    if not Path(image_path).exists():
        raise FileNotFoundError("The specified input image file does not exist.")

    # Prepare arguments for the extract function
    class Args:
        pass
    args = Args()
    args.img_path = image_path
    args.output_path = output_path
    args.use_tf = use_tf
    args.save_cache = save_cache
    args.without_deskew = without_deskew

    # Call the extract function to convert the image to MusicXML
...
output_musicxml = "path/to/save/output.musicxml"
output_path = image_to_musicxml(input_image, output_musicxml)
print(f"MusicXML file generated successfully: {output_path}")
